...
- Worktree root: /home/redisx/.worktree/omx-team/use-home-redisx-omx-c-278cc225/worker-1
- Team state root: /home/redisx/.omx/state
- Inbox path: /home/redisx/.omx/state/team/use-home-redisx-omx-c-278cc225/workers/worker-1/inbox.md
- Mailbox path: /home/redisx/.omx/state/team/use-home-redisx-omx-c-278cc225/mailbox/worker-1.json
...
- Worker status path: /home/redisx/.omx/state/team/use-home-redisx-omx-c-278cc225/workers/worker-1/status.json
- Worker identity path: /home/redisx/.omx/state/team/use-home-redisx-omx-c-278cc225/workers/worker-1/identity.json

## Protocol
1. Read your inbox at `/home/redisx/.omx/state/team/use-home-redisx-omx-c-278cc225/workers/worker-1/inbox.md`.
...
3. Send startup ACK before task work:
   ...
   `omx team api send-message --input "{"team_name":"use-home-redisx-omx-c-278cc225","from_worker":"worker-1","to_worker":"leader-fixed","body":"ACK: worker-1 initialized"}" --json`
...
7. Use mailbox delivery flow:
   - `omx team api mailbox-list --input "{"team_name":"use-home-redisx-omx-c-278cc225","worker":"worker-1"}" --json`
   - `omx team api mailbox-mark-delivered --input "{"team_name":"use-home-redisx-omx-c-278cc225","worker":"worker-1","message_id":"<MESSAGE_ID>"}" --json`
