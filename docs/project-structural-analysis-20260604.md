...
生成日期：2026-06-04  
分析范围：`/home/redisx` 当前仓库、治理门禁、发布路径、模板生成路径、文档与 Evidence Runtime  
...
```bash
DOCKER_TOOL_CACHE=/home/redisx/.cache/docker-tools
PATH=/home/redisx/.cache/docker-tools/bin:$PATH
