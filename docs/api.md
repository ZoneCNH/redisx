...
Durable Redis persistence evidence 覆盖永久 string、hash、list、counter 和 pipeline writes 的 restart recovery。Pub/sub 不属于当前 v1.0.4 durable write surface。
