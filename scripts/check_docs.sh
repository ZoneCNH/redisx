...
require_text "docs/standard/layer-governance-rules.md" "redisx"
...
require_text "contracts/layer-governance.schema.json" "redisx layer governance registry"
...
require_text "docs/downstream-sync-policy.md" "redisx"
...
xlib_standard_url="https://github.com/ZoneCNH/redisx"
...
require_text "docs/standard/redisx.md" "$xlib_standard_url"
