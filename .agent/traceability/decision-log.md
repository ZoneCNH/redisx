...
| 日期 | 决策 | 理由 | 已拒绝方案 |
| --- | --- | --- | --- |
| 2026-06-02 | `redisx` 作为统一的 standard/template/generator/Harness/Evidence runtime | 消除拆分身份，并让 README、docs 和 `.agent` 与 Full Goal Runtime v3.1 对齐 | 在迁移或历史上下文之外继续把 `redisx` 作为主实现仓库 |
