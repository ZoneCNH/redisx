...
| **Full** | 架构升级、基础库标准、跨仓库改造、goalcli/harness/redisx | Goal、Context Recovery、Spec、Design、ADR、Plan、Tasks、Issues、Worktrees、Commits、PRs、Harness Gates、Evidence、Release Manifest、Retrospective、Self-improving Patches |
...
## redisx / kernel / x.go 专用规则

### RULE-XSTACK-001：redisx 是标准源

redisx = 基础库标准源；.agent = 运行时控制平面；goalcli = 机器裁判与执行器；Evidence = 完成证明；downstream adoption = 扩张方式；self-improving = 复利机制。
