...
func buildDockerEvidence() DockerEvidence {
	...
	toolchainImage := envDefault("DOCKER_TOOLCHAIN_IMAGE", envDefault("DOCKER_IMAGE", "redisx-toolchain:local"))
	return DockerEvidence{
		...
		GovulncheckVersion:   envDefault("DOCKER_GOVULNCHECK_VERSION", "govulncheck v1.1.4"),
		...
		RuntimeImage:         envDefault("DOCKER_RUNTIME_IMAGE", "redisx-goalcli-runtime:local"),
